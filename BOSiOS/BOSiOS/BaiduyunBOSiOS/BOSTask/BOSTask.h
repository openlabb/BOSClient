...
/*!
 Error domain used if there was multiple errors on <BOSTask taskForCompletionOfAllTasks:>.
 */
extern NSString *const BOSTaskErrorDomain;

/*!
 An error code used for <BOSTask taskForCompletionOfAllTasks:>, if there were multiple errors.
 */
extern NSInteger const kBFMultipleErrorsError;

/*!
 An exception that is thrown if there was multiple exceptions on <BOSTask taskForCompletionOfAllTasks:>.
 */
extern NSString *const BOSTaskMultipleExceptionsException;

/*!
 An error userInfo key used if there were multiple errors on <BOSTask taskForCompletionOfAllTasks:>.
 Value type is `NSArray<NSError *> *`.
 */
extern NSString *const BOSTaskMultipleErrorsUserInfoKey;

/*!
 An error userInfo key used if there were multiple exceptions on <BOSTask taskForCompletionOfAllTasks:>.
 Value type is `NSArray<NSException *> *`.
 */
extern NSString *const BOSTaskMultipleExceptionsUserInfoKey;

@class BOSExecutor;
@class BOSTask;

/*!
 The consumer view of a Task. A BOSTask has methods to
 inspect the state of the task, and to add continuations to
 be run once the task is complete.
 */
@interface BOSTask<__covariant ResultType> : NSObject

/*!
 A block that can act as a continuation for a task.
 */
typedef __nullable id(^BOSContinuationBlock)(BOSTask<ResultType> *task);
...
/*!
 ...
 @param executor A BOSExecutor responsible for determining how the
 continuation block will be run.
 @param block The block to immediately schedule to run with the given executor.
 @returns A task that will be completed after block has run.
 If block returns a BOSTask, then the task returned from
...
/*!
 ...
 this method will not be completed until that task is completed.
 */
- (BOSTask *)continueWithExecutor:(BOSExecutor *)executor withSuccessBlock:(BOSContinuationBlock)block;
