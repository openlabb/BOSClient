...
@class BOSTask<ResultType>;

/*!
 A BOSTaskCompletionSource represents the producer side of tasks.
 It is a task that also has methods for changing the state of the
 task by settings its completion values.
 */
@interface BOSTaskCompletionSource<__covariant ResultType> : NSObject
 ...
 */
@property (nonatomic, strong, readonly) BOSTask<ResultType> *task;
